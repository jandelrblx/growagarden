...
duplicateBtn.MouseButton1Click:Connect(function()
    ...
    if tool then
        ...
        Instance.new("UICorner", tempLoading).CornerRadius = UDim.new(0, 8)
        
        -- Header (Green Bar)
        local loadingHeader = Instance.new("Frame", tempLoading)
        loadingHeader.Size = UDim2.new(1, 0, 0, 30)
        loadingHeader.BackgroundColor3 = Color3.fromRGB(85, 255, 105)
        ...
        -- Page Content Area
        local loadingPage = Instance.new("Frame", tempLoading)
        loadingPage.Size = UDim2.new(1, -20, 1, -40)
        loadingPage.Position = UDim2.new(0, 10, 0, 35)
        loadingPage.BackgroundColor3 = Color3.fromRGB(75, 50, 25)
        Instance.new("UICorner", loadingPage).CornerRadius = UDim.new(0, 6)
        
        -- Particle animation in loading box
        local particleFolder = Instance.new("Folder", loadingPage)
        particleFolder.Name = "Particles"
        local function spawnParticle()
            local particle = Instance.new("Frame")
            particle.Size = UDim2.new(0, math.random(2, 6), 0, math.random(2, 6))
            local maxX = 1 - (particle.Size.X.Offset / loadingPage.Size.X.Offset)
            local maxY = 1 - (particle.Size.Y.Offset / loadingPage.Size.Y.Offset)
            particle.Position = UDim2.new(math.random() * maxX, 0, math.random() * maxY, 0)
            particle.BackgroundColor3 = Color3.fromRGB(
                85 + math.random(-10, 10),
                255 + math.random(-10, 10),
        ...
        local label = Instance.new("TextLabel", loadingPage)
        ...
        local barBG = Instance.new("Frame", loadingPage)
        barBG.Size = UDim2.new(0.85, 0, 0, 12)
        barBG.Position = UDim2.new(0.075, 0, 0, 30)
        barBG.BackgroundColor3 = Color3.fromRGB(94, 62, 35)
        Instance.new("UICorner", barBG).CornerRadius = UDim.new(1, 0)
        local bar = Instance.new("Frame", barBG)
        bar.Size = UDim2.new(0, 0, 1, 0)
        bar.BackgroundColor3 = Color3.fromRGB(85, 255, 105)
        ...
        local percent = Instance.new("TextLabel", loadingPage)
        percent.Size = UDim2.new(0, 80, 0, 20)
        percent.Position = UDim2.new(0.5, -40, 0, 50)
        percent.Text = "0%"
